...
## Phase 2 - 10 min - Analyze and Risk Triage
14. Ask Copilot:
...
28. If a suggested fix changes production code unexpectedly, reject it and note the finding in `docs/NOTES.md`.
29. Log updated coverage in `docs/NOTES.md`.

## Phase 5 - 13 min - Implement One Safe Refactor
30. Open `REFACTOR_PLAN.md` and pick the lowest-risk step.
31. Ask Copilot to implement only that step:
    - `Implement Step N from my REFACTOR_PLAN.md on DateUtils.java. Apply only that change and do not touch anything else.`
