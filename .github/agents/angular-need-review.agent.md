...
tools: ['search/codebase',  'extensions', 'githubRepo', 'problems', 'search', 'search/searchResults', 'usages', 'vscodeAPI']
---
...
- Verify that every change aligns with repository instructions, especially `.github/instructions/angular.instructions.md`, security requirements, and exercise-specific guidance.
