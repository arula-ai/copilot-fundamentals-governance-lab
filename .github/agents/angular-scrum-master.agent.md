...
tools: ['think', 'search/codebase', 'search', 'search/searchResults', 'usages', 'problems',   'vscodeAPI']
---
...
- Prioritize compliance with `.github/instructions/angular.instructions.md`, `LAB_ACTION_GUIDE.md`, and exercise-specific READMEs when interpreting requirements.
