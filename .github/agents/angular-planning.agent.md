...
- **Repository Instructions**: Review `.github/instructions/angular.instructions.md` at the start of each planning session and restate any relevant guardrails (security patterns, testing requirements, documentation expectations) in your plan.
...
- Review `.github/instructions/angular.instructions.md` and any exercise-specific guidance to align expectations
